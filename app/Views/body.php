...
<div class="dashboard-container">
    ...
    <div class="stats-container">
        ...
        <div class="stat-card books-card">
            <div class="card-glass">
                ...
                <div class="stat-content">
                    <h3 class="stat-value counter" data-target="<?= esc($total_books) ?>">0</h3>
        ...
        <div class="stat-card users-card">
            <div class="card-glass">
                ...
                <div class="stat-content">
                    <h3 class="stat-value counter" data-target="<?= esc($total_users) ?>">0</h3>
        ...
        <div class="stat-card authors-card">
            <div class="card-glass">
                ...
                <div class="stat-content">
                    <h3 class="stat-value counter" data-target="<?= esc($total_authors) ?>">0</h3>
    ...
    <div class="users-section">
        <div class="section-header">
            <h3 class="section-title">Last 5 Registered Users</h3>
        ...
        <?php if (!empty($last_users)): ?>
            <div class="table-container">
                <table class="users-table">
                    ...
                    <tbody>
                        <?php foreach ($last_users as $index => $user): ?>
                            <tr class="table-row" data-index="<?= $index ?>">
                                <td>
                                    <div class="user-cell">
                                        <div class="user-avatar">
                                            <img src="<?= base_url('public/uploads/library_users/' . $user->image) ?>" alt="<?= esc($user->username) ?>">
                                            <span class="status-dot <?= $user->status === 'active' ? 'active' : 'inactive' ?>"></span>
                                        </div>
                                        <div class="user-info">
                                            <h4 class="user-name"><?= esc($user->username) ?></h4>
                                            <p class="user-joined">
                                                Joined 
                                                <span class="highlight">
                                                    <?php
                                                        $today = date('Y-m-d');
                                                        $registered = date('Y-m-d', strtotime($user->register_date));
                                                        echo ($registered === $today) 
                                                            ? 'Today' 
                                                            : date('j F Y', strtotime($user->register_date)); // e.g. 10 June 2025
                                                    ?>
                                                </span>
                                            </p>
                                        </div>
                                ...
                                <td>
                                    <div class="table-cell">
                                        ...
                                        <span><?= esc($user->phone_number) ?></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="table-cell">
                                        <i class="fas fa-venus-mars cell-icon"></i>
